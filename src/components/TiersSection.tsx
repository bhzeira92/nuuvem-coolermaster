...
const tiers = [
  {
    ...
    highlight: "Domínio total do stand e do naming — a Cooler Master é o hardware oficial da Gamescom LATAM × Nuuvem.",
    items: [
      "Naming rights: 'Nuuvem Arena powered by Cooler Master'",
      "Logo em TODOS os 16 PCs, monitores, periféricos e backdrop",
      "Exclusividade de categoria hardware durante o evento",
      "Produto showcase dedicado no Cloud Lounge VIP",
      "4 convites VIP + 2 sessões exclusivas com top creators",
      "Campanha digital co-branded (67M reach)",
      "Relatório completo de métricas e ROI pós-evento",
    ],
  },
  {
    badge: "Partner",
